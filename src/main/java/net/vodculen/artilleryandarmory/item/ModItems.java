...
public class ModItems {
    ...
    public static final Item HAMMER = registerItem("hammer", new Hammer(ModToolMaterials.HAMMER, 13, -3.9F, new Item.Settings()));

    public static final Item CHAMBER = registerItem("chamber", new Hammer(ModToolMaterials.HAMMER, 15, -3.95f, new Item.Settings()));
