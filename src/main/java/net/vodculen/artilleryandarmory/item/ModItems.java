...
public class ModItems {
    ...
    public static final Item HAMMER = registerItem("hammer", new Hammer(ModToolMaterials.HAMMER, 15, -3.9F, new Item.Settings())); // this is just extra attack damage and speed for the sword to apply to itself while the rest of the tools will use the values declared in the ModToolMaterials 
